  ...
  return (
    <div className='container mx-auto px-8 md:px-4 py-8'>
      ...
      <p className='text-lg mb-6'>
        Get Me A Chai is a crowdfunding platform designed for creators to fund their projects with the support of their fans. It's a space where your fans can directly contribute to your creative endeavours by buying you a chai. Unlock the potential of your fanbase and bring your projects to life.
      </p>
      ...
      <div className='grid grid-cols-1 sm:grid-cols-2 gap-8'>
        ...
        <div className='flex items-center mb-6'>
          <img className='w-20 h-20 rounded-full mr-4' src="/man.gif" alt="Support through Chai" />
          <div>
      ...
      <ul className='list-disc pl-6 mb-6'>
        ...
        <li className='mb-2'>Receive valuable feedback and encouragement from experienced creators</li>
