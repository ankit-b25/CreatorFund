...
import { updateProfile, fetchuser, fetchpayments } from "@/actions/useractions"
...
const Dashboard = () => {
    ...
    return (
        ...
        <div className="container mx-auto py-5 px-5">
            <h1 className="text-center my-5 text-3xl font-bold mb-7">Welcome to your Dashboard</h1>
            ...
            <form className="max-w-2xl mx-auto" action={handleSubmit}>
                ...
                {/* Submit Button */}
                <div className="my-6">
                    <button type="submit" className="block w-full p-2 text-white bg-blue-500 rounded-lg hover:bg-blue-600 focus:ring-blue-700 focus:ring-4 focus:outline-none dark:focus:ring-blue-800 font-medium text-sm">Save</button>
                </div>
            </form>
        </div>
        </>
